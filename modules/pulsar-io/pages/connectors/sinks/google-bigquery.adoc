...
[#configs]
=== Kafka Connect Adapter parameters (`configs`)

The parameters in the `configs` section define how data is streamed from {pulsar-short} to BigQuery.
...
Set these parameters in the `kafkaConnectorConfigProperties` section of the connector configuration.
