...
Sink connectors export messages from {pulsar-short} topics to external systems.
...
Source connectors ingest messages from external systems into {pulsar-short} topics.
